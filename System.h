...
public:
    ...
    {
    public:
        enum class Result { Success, Busy, ParityError, FramingError, NoiseDetected, OverrunError, LineBreak, CommandResponse, CommandSent, CommandCrcFail, CommandTimeout, DataSuccess, DataFail, Nack };
        class Callback
        {
        public:
